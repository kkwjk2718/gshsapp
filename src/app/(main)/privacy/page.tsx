...
export default function PrivacyPage() {
  return (
    <div className="mobile-page mobile-safe-bottom max-w-3xl mx-auto space-y-8">
       <div className="space-y-2 border-b pb-6" style={{ borderColor: "var(--border)" }}>
          <h1 className="text-3xl font-bold" style={{ color: "var(--foreground)" }}>개인정보 처리방침</h1>
          <p style={{ color: "var(--muted)" }}>최종 수정일: 2025년 11월 20일</p>
       </div>

       <article className="prose dark:prose-invert max-w-none space-y-6" style={{ color: "var(--muted)" }}>
          <section>
             <h2 className="text-xl font-bold mb-3" style={{ color: "var(--foreground)" }}>1. 총칙</h2>
             <p>
          ...
          <section>
             <h2 className="text-xl font-bold mb-3" style={{ color: "var(--foreground)" }}>2. 수집하는 개인정보의 항목 및 수집 방법</h2>
          ...
          <section>
             <h2 className="text-xl font-bold mb-3" style={{ color: "var(--foreground)" }}>3. 개인정보의 수집 및 이용 목적</h2>
          ...
          <section>
             <h2 className="text-xl font-bold mb-3" style={{ color: "var(--foreground)" }}>4. 개인정보의 보유 및 이용 기간</h2>
             <p>
          ...
          <section>
             <h2 className="text-xl font-bold mb-3" style={{ color: "var(--foreground)" }}>5. 개인정보의 파기 절차 및 방법</h2>
             <p>
          ...
          <section>
             <h2 className="text-xl font-bold mb-3" style={{ color: "var(--foreground)" }}>6. 이용자의 권리와 행사 방법</h2>
             <p>
          ...
          <section>
             <h2 className="text-xl font-bold mb-3" style={{ color: "var(--foreground)" }}>7. 개인정보 보호책임자</h2>
