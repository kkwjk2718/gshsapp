...
export type AuditTargetType = "SYSTEM_LOG" | "USER" | "TOKEN_BATCH" | "INVITE_TOKEN" | "TOKEN_DISTRIBUTION" | "SYSTEM_SETTING" | "BACKUP" | "NOTIFICATION" | "LINK" | "RELATED_SITE" | "NOTICE_CATEGORY" | "SONG_REQUEST" | "ERROR_REPORT";
...
const TARGET_TYPES = new Set<AuditTargetType>(["SYSTEM_LOG", "USER", "TOKEN_BATCH", "INVITE_TOKEN", "TOKEN_DISTRIBUTION", "SYSTEM_SETTING", "BACKUP", "NOTIFICATION", "LINK", "RELATED_SITE", "NOTICE_CATEGORY", "SONG_REQUEST", "ERROR_REPORT"]);
