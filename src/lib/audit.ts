...
export const AUDIT_ACTIONS = [
  ...
  "ADMIN_NOTIFICATION_SENT", "GRADE_MAPPING_CHANGED", "ICAL_FEED_CHANGED", "ANALYTICS_SETTING_CHANGED",
  "LINK_CREATED", "LINK_UPDATED", "LINK_DELETED",
  "RELATED_SITE_CREATED", "RELATED_SITE_DELETED", "NOTICE_CATEGORY_CREATED", "NOTICE_CATEGORY_DELETED",
  "SONG_STATUS_CHANGED", "SONG_RULES_CHANGED", "REPORT_STATUS_CHANGED",
  "BACKUP_RESTORE_REQUESTED", "BACKUP_RESTORE_STAGED", "BACKUP_RESTORE_REJECTED",
  "BACKUP_RESTORE_CANCEL_REQUESTED", "BACKUP_RESTORE_CANCELLED",
  "BACKUP_CREATE_REQUESTED",
] as const;
export type AuditAction = (typeof AUDIT_ACTIONS)[number];
export type AuditTargetType = "SYSTEM_LOG" | "USER" | "TOKEN_BATCH" | "INVITE_TOKEN" | "TOKEN_DISTRIBUTION" | "STUDENT_ROSTER" | "SYSTEM_SETTING" | "BACKUP" | "NOTIFICATION" | "LINK" | "RELATED_SITE" | "NOTICE_CATEGORY" | "SONG_REQUEST" | "ERROR_REPORT";
...
const TARGET_TYPES = new Set<AuditTargetType>(["SYSTEM_LOG", "USER", "TOKEN_BATCH", "INVITE_TOKEN", "TOKEN_DISTRIBUTION", "STUDENT_ROSTER", "SYSTEM_SETTING", "BACKUP", "NOTIFICATION", "LINK", "RELATED_SITE", "NOTICE_CATEGORY", "SONG_REQUEST", "ERROR_REPORT"]);
